...
DynaMO(readlist=histonelist,peak=peak,motif=motif,mode="l",
       ...
       motiflen=300,motifbin=20,cluster=0,fdrcut=0.01)
```
...
for(markcount in 1:markernum){
  histonemotifsegreads[[markcount]]<-countmotifsegreads(
    reads[[markcount]],motifsegs,readlen,
...
colnames(motiffdrclstest)=paste(rep(paste("cluster",1:clsnum))
                            ,rep(c("count","ratio","p-value","padj"),each=4))
```
